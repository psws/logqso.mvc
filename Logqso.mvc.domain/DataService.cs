...
namespace Logqso.mvc.domain
{
       ...
       /// <summary>
        ...
        /// </summary>
    public class DataService : Service<CatOperator>, IDataService
    {
        private readonly IRepositoryAsync<CatOperator> _repository;

        public DataService(IRepositoryAsync<CatOperator> repository)
            : base(repository)
        {
        ...
        public  Task<ContestControlEntity> GetContestControlNames()
        {
            ...
            ContestControlEntity.ControlCategoryEntity.CatOperator = _repository.GetContestCategoryNames();
            ...
            ContestControlEntity.ControlFiltersEntity.FiltCountry = FiltPrefixes.GetFiltPrefixNames();
